...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < population.length; i++) {
            ...
            dataItems.add(new DataItem(city[i], population[i]));
        }
